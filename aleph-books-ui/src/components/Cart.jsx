...
export default function Cart() {
  ...
  return (
    <div className="min-h-214 py-12 bg-normalbg dark:bg-darkbg font-primary">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center text-gray-600 dark:text-lighter flex flex-col items-center">
          ...
          <button
            onClick={handleClick}
            className="py-2 px-4 bg-primary dark:bg-light text-white dark:text-black text-xl font-semibold rounded-sm flex justify-center items-center hover:cursor-pointer hover:bg-dark dark:hover:bg-dark dark:hover:text-light transition"
          >
            Back to Products
          </button>
        </div>
